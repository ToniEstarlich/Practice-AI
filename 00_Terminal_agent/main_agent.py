...
<body>
    <div class="container">
        <h1>Hello Techne</h1>
        <p class="subtitle">Powered by FastAPI & AI</p>
        <div class="status">
            <span class="status-dot"></span> Server is running
        </div>
        <div class="links">
        ...
        <p class="info">Built by TECHNE AI Agent — FastAPI v{version}</p>
    </div>
</body>
</html>
""".format(version=__import__("fastapi").__version__)
...
async def api_info():
    return {
        ...
        "description": "A beautiful FastAPI website built by TECHNE 🤖",
        "version": "1.0.0",
        "tech_stack": ["FastAPI", "Python", "AI"],
        "endpoints": [
            {"path": "/", "method": "GET", "description": "Home page"},
            {"path": "/api/info", "method": "GET", "description": "API info"},
            {"path": "/api/time", "method": "GET", "description": "Current server time"},
